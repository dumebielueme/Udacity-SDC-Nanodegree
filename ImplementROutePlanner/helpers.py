...
map_test_dict = {
	0: {'pos': (0., 0.), 'connections': [2, 3]}, 
	1: {'pos': (0.1, 0.1), 'connections': [2]}, 
	2: {'pos': (0.1, 0.2), 'connections': [0, 1]}, 
	3: {'pos': (0.3, 0.1), 'connections': [0]}, 
   	4: {'pos': (0.4, 0.2), 'connections': [2, 3, 5]}, 
   	5: {'pos': (0.5, 0.2), 'connections': [4,3]}, 
}
...
def load_map_test():
	G = load_map_graph(map_test_dict)
	return Map(G)
